      ...
      <div className="big_screen_entire_bottom_wrapper">
        <div className="big_screen_price_wrapper">
          <FontAwesomeIcon
            ...
            icon={faTag}
          />
          <p className="big_screen_price">rs. 3000</p>
        </div>
                ...
                <section className="card" style={styleprops}>
                    ...
                    >
                      {(styles) => (
                        <>
                          ...
                          <img src="https://4.imimg.com/data4/FR/XF/MY-27291509/agriculture-sprinkler-500x500.jpg" />
                        </>
                      )}
                    </Spring>
                    <div
                  ...
                  >
                    <div className="card_description_inner_wrapper">
                      <h2 style={{ fontWeight: 400 }}>Water Sprinkler</h2>
