      ...
      <div className="big_screen_entire_bottom_wrapper">
        <div className="big_screen_price_wrapper">
          <FontAwesomeIcon
            ...
            icon={faTag}
          />
          <p className="big_screen_price"> Rs 25,000 </p>
        </div>
                ...
                <section className="card" style={styleprops}>
                    ...
                    >
                      {(styles) => (
                        <>
                          ...
                          <img src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWxPCuhG16CCErMGOEJtq4xNOplGRZ4iUbMA&usqp=CAU" />
                        </>
                      )}
                    </Spring>
                  ...
                  >
                    <div className="card_description_inner_wrapper">
                      <h2 style={{ fontWeight: 400 }}>Irrigation factility</h2>
