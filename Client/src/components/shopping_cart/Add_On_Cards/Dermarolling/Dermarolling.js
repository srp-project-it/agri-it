      ...
      <div className="big_screen_entire_bottom_wrapper">
        <div className="big_screen_price_wrapper">
          <FontAwesomeIcon
            ...
            icon={faTag}
          />
          <p className="big_screen_price"> Rs 50,000 </p>
        </div>
                    ...
                    >
                      {(styles) => (
                        <>
                          ...
                          <img src = "https://uploads-ssl.webflow.com/61a503785b6ce52e8fbf3b6d/61b87c518515900934480312_Livestock-and-its-Influence-on-Human-Beings.jpeg" />
                        </>
                      )}
                    </Spring>
                    <div
