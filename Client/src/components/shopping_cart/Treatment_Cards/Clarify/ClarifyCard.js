...
const ClarifyCard = (props) => {
  ...
  return (
    <div className="shopping_cart_card_wrapping">
      ...
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTys4AlOtJJEryS-BWLIpGkF00mb_AP2DPyaQ&usqp=CAU" width="100%" viewBox="0 0 50.006 50.006"/>

      </div>
      <div className="shopping_cart_card_description">
        <div className="cart_card_top_container">
          <h3>Insect Pest Management</h3>
