...
const GlowCard = (props) => {
  ...
  return (
    <div className="shopping_cart_card_wrapping">
      ...
      <img src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDyDkLWfMPk7CJNfoHuJhOCaaL0yXjPsPpTA&usqp=CAU" viewBox="0 0 56.356 56.356" width="100%"  />
      </div>
      <div className="shopping_cart_card_description">
        <div className="cart_card_top_container">
          <h3>Consultation on tools</h3>
