...
const BacialCard = (props) => {
  ...
  return (
    <div className="shopping_cart_card_wrapping">
      ...
      <img src="https://www.souriau.com/en-en/system/files/zapp2photo-shutterstock_645059614_-_copie-min.jpg" width="100%" viewBox="0 0 56.356 56.356"/>

      </div>
      <div className="shopping_cart_card_description">
        <div className="cart_card_top_container">
          <h3>Lighting consultation </h3>
